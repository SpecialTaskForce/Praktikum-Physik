...
\[ J_{Quader} = \frac{m}{12}(l^2 + b^2) = \frac{0.235}{12}(0.02^2 + 0.07^2) = 0.000103792 kgm^2 \]
f\"ur den Quader und
\[  J_{Scheibe} = \frac{1}{2}mR^2 = \frac{1}{2} * 0.3 * 0.05^2 = 0.000375kgm^2 \]
f\"ur die Scheibe.
...
\[ J_{Tisch} = \frac{T^2k}{4\pi^2} = \frac{1.182^2*0.0179882}{4\pi^2} = 0.000636594kgm^2 \]
Das Tr\"agheitsmoment des Quaders betr\"agt nach unseren Messungen
\[ J_{Quader} = \frac{T^2k}{4\pi^2} - J_{Tisch} = \frac{1.28^2*0.0179882}{4\pi^2} - 0.000636594 = (0.000109936 \pm 0.000183226) kgm^2 \]
Das Tr\"agheitsmoment der Scheibe betr\"agt nach unseren Messungen
\[ J_{Scheibe} = \frac{T^2k}{4\pi^2} - J_{Tisch} = \frac{1.5005^2*0.0179882}{4\pi^2} - 0.000636594 = (0.000389293 \pm 0.00021479) kgm^2 \]
