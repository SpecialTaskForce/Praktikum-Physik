...
\end{equation}
Das Tr\"agheitsmoment $J_{Zylinder}$ eines homogenen Zylinders der Masse $m$ mit Radius $R$ und H\"ohe $h$ ist gegeben durch:
\begin{equation}
...
\end{equation}
Die Rotationsenergie $E_{rot}$ eines beliebigen K\"orpers mit Tr\"agheitsmoment $J$ und Winkelgeschindigkeit $\omega$ l\"asst sich durch folgende Formel bestimmen:
\begin{equation}
E_{rot} = \frac{1}{2}J\omega^2
\end{equation}
Der Drehimpuls $L$ bei einem Tr\"agheitsmoment $J$ und Winkelgeschwindigkeit $\omega$ ist durch folgende Formel gegeben:
\begin{equation}
L = J\omega
\end{equation}
